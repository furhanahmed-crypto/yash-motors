...
<footer class="site-footer">
    ...
    <div class="container">
        <div class="footer-grid footer-grid--three">
            <div class="footer-brand">
                ...
                <div class="social-links">
                    <a href="<?php echo htmlspecialchars($site['social']['whatsapp']); ?>" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
                    ...
                    <a href="<?php echo htmlspecialchars($site['social']['instagram']); ?>" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                    ...
                    <a href="<?php echo htmlspecialchars($site['social']['facebook']); ?>" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
            ...
            <div class="footer-col">
                <h4>Quick Links</h4>
                <ul>
                    <li><a href="<?php echo page_url('index'); ?>">Home</a></li>
            ...
            <div class="footer-col">
                ...
                <ul class="footer-contact">
                    ...
                    <li>
                        ...
                        <a href="tel:<?php echo preg_replace('/\s+/', '', $site['phone']); ?>"><?php echo htmlspecialchars($site['phone']); ?></a>
                    </li>
                    <li>
        ...
        <div class="footer-bottom">
            <p>&copy; <?php echo date('Y'); ?> <?php echo htmlspecialchars($site['name']); ?>. All rights reserved. | Kompally, Hyderabad | Powered by clean energy and honest service.</p>
        </div>
    </div>
</footer>
