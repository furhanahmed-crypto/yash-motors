<section class="section showrooms-premium" id="showrooms">
    <div class="container">
        ...
        <div class="section-header-premium reveal">
            <span class="eyebrow-premium">Our Showroom</span>
            <h2>Visit us in Kompally.</h2>
            <p>Come see us at Yash Motors in Kompally — our EV specialists are ready to help you explore, test-ride, and service your electric vehicle.</p>
        </div>
        <?php } ?>

        <div class="showrooms-grid-premium showrooms-grid-premium--single reveal">
            <?php foreach ($showrooms as $showroom) {
                $is_featured = !empty($showroom['featured']);
            ?>
            <article class="showroom-card-premium<?php echo $is_featured ? ' showroom-card-premium--featured' : ''; ?> showroom-card-premium--full card-theme--green">
                <div class="showroom-card-inner">
                    <div class="showroom-card-main">
                    ...
                    <div class="showroom-card-actions">
                        ...
                        <?php if (!empty($showroom['directions'])) { ?>
